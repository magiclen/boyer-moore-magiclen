...
impl BMLatin1 {
    pub fn find_full_all_in_u8_slice<B: ?Sized + AsRef<[u8]>>(&self, text: &B) -> Vec<usize> {
        find_full_in_u8_slice(text, &self.pattern, &self.bad_char_shift_map, 0)
    }

    pub fn find_full_all_in_str<S: AsRef<str>>(&self, text: S) -> Vec<usize> {
        find_full_in_str(text, &self.pattern, &self.bad_char_shift_map, 0)
    }
    ...
    pub fn find_full_first_in_u8_slice<B: ?Sized + AsRef<[u8]>>(&self, text: &B) -> Option<usize> {
        find_full_in_u8_slice(text, &self.pattern, &self.bad_char_shift_map, 1).get(0).map(|&p| p)
    }

    pub fn find_full_first_in_str<S: AsRef<str>>(&self, text: S) -> Option<usize> {
        find_full_in_str(text, &self.pattern, &self.bad_char_shift_map, 1).get(0).map(|&p| p)
    }
    ...
    pub fn find_full_in_u8_slice<B: ?Sized + AsRef<[u8]>>(&self, text: &B, limit: usize) -> Vec<usize> {
        find_full_in_u8_slice(text, &self.pattern, &self.bad_char_shift_map, limit)
    }

    pub fn find_full_in_str<S: AsRef<str>>(&self, text: S, limit: usize) -> Vec<usize> {
        find_full_in_str(text, &self.pattern, &self.bad_char_shift_map, limit)
    }
...
impl BMLatin1 {
    pub fn rfind_full_all_in_u8_slice<B: ?Sized + AsRef<[u8]>>(&self, text: &B) -> Vec<usize> {
        rfind_full_in_u8_slice(text, &self.pattern, &self.bad_char_shift_map_rev, 0)
    }

    pub fn rfind_full_all_in_str<S: AsRef<str>>(&self, text: S) -> Vec<usize> {
        rfind_full_in_str(text, &self.pattern, &self.bad_char_shift_map_rev, 0)
    }
    ...
    pub fn rfind_full_first_in_u8_slice<B: ?Sized + AsRef<[u8]>>(&self, text: &B) -> Option<usize> {
        rfind_full_in_u8_slice(text, &self.pattern, &self.bad_char_shift_map_rev, 1).get(0).map(|&p| p)
    }

    pub fn rfind_full_first_in_str<S: AsRef<str>>(&self, text: S) -> Option<usize> {
        rfind_full_in_str(text, &self.pattern, &self.bad_char_shift_map_rev, 1).get(0).map(|&p| p)
    }
    ...
    pub fn rfind_full_in_u8_slice<B: ?Sized + AsRef<[u8]>>(&self, text: &B, limit: usize) -> Vec<usize> {
        rfind_full_in_u8_slice(text, &self.pattern, &self.bad_char_shift_map_rev, limit)
    }

    pub fn rfind_full_in_str<S: AsRef<str>>(&self, text: S, limit: usize) -> Vec<usize> {
        rfind_full_in_str(text, &self.pattern, &self.bad_char_shift_map_rev, limit)
    }
...
pub fn find_full_in_u8_slice<B: ?Sized + AsRef<[u8]>, P: ?Sized + AsRef<[u8]>>(text: &B, pattern: &P, bad_char_shift_map: &BMLatin1BadCharShiftMap, limit: usize) -> Vec<usize> {
...
pub fn find_full_in_str<S: AsRef<str>, P: ?Sized + AsRef<[u8]>>(text: S, pattern: &P, bad_char_shift_map: &BMLatin1BadCharShiftMap, limit: usize) -> Vec<usize> {
    let text = text.as_ref();

    find_full_in_u8_slice(text, pattern, bad_char_shift_map, limit)
}

pub fn find_full_in_char_slice<P: ?Sized + AsRef<[u8]>>(text: &[char], pattern: &P, bad_char_shift_map: &BMLatin1BadCharShiftMap, limit: usize) -> Vec<usize> {
    let text = text.as_ref();
    let pattern = pattern.as_ref();
...
pub fn rfind_full_in_u8_slice<B: ?Sized + AsRef<[u8]>, P: ?Sized + AsRef<[u8]>>(text: &B, pattern: &P, bad_char_shift_map: &BMLatin1BadCharShiftMapRev, limit: usize) -> Vec<usize> {
    let text = text.as_ref();
    let pattern = pattern.as_ref();
...
pub fn rfind_full_in_str<S: AsRef<str>, P: ?Sized + AsRef<[u8]>>(text: S, pattern: &P, bad_char_shift_map: &BMLatin1BadCharShiftMapRev, limit: usize) -> Vec<usize> {
    let text = text.as_ref();

    rfind_full_in_u8_slice(text, pattern, bad_char_shift_map, limit)
}

pub fn rfind_full_in_char_slice<P: ?Sized + AsRef<[u8]>>(text: &[char], pattern: &P, bad_char_shift_map: &BMLatin1BadCharShiftMapRev, limit: usize) -> Vec<usize> {
    let text = text.as_ref();
    let pattern = pattern.as_ref();
